...
SGE.PesquisaRapidaCliente = (function() {
	...
	function onPesquisaConcluida(resultado) {
		...
		var tabelaClientePesquisaRapida = new SGE.TabelaClientePesquisaRapida(this.pesquisaRapidaClientesModal);
...
SGE.TabelaClientePesquisaRapida = (function() {
...
$(function() {
	var pesquisaRapidaCliente = new SGE.PesquisaRapidaCliente();
